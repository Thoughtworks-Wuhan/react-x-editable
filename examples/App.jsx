  ...
  />`}</pre>
                        ...
                        <td width="65%">
                            <Button bsStyle="link" bsSize="xsmall"
                                    onClick={() => this.setState({ simpleTextField: !this.state.simpleTextField })}>
...
/>`}</pre>
                        ...
                        <td width="65%">
                            <Button bsStyle="link" bsSize="xsmall"
                                    onClick={() => this.setState({ emptyRequiredTextField: !this.state.emptyRequiredTextField })}>
                                <i className="fa fa-code" title="show/hide code"></i>
                            </Button>
                        </td>
                    </tr>
...
/>`}</pre>
                        ...
                        <td width="65%">
                            <Button bsStyle="link" bsSize="xsmall"
                                    onClick={() => this.setState({ simpleTexareatField: !this.state.simpleTexareatField })}>
                                <i className="fa fa-code" title="show/hide code"></i>
                            </Button>
                        </td>
                    </tr>
                        ...
                        <td>
                            <Editable
                                ...
                                display={function (value) {
                                    return (
                                        <span><Label bsStyle="default">City:</Label><span>&nbsp;{value}</span></span>);
                                }}
                            />
...
/>`}</pre>
                        ...
                        <td width="65%">
                            <Button bsStyle="link" bsSize="xsmall"
                                    onClick={() => this.setState({ simpleSelectCustomDisp: !this.state.simpleSelectCustomDisp })}>
                                <i className="fa fa-code" title="show/hide code"></i>
                            </Button>
                        </td>
                    </tr>
...
/>`}</pre>
                        ...
                        <td width="65%">
                            <Button bsStyle="link" bsSize="xsmall"
                                    onClick={() => this.setState({ simpleCheckboxlist: !this.state.simpleCheckboxlist })}>
                                <i className="fa fa-code" title="show/hide code"></i>
                            </Button>
                        </td>
                    </tr>
...
/>`}</pre>
                        ...
                        <td width="65%">
                            <Button bsStyle="link" bsSize="xsmall"
                                    onClick={() => this.setState({ customComponent: !this.state.customComponent })}>
                                <i className="fa fa-code" title="show/hide code"></i>
                            </Button>
                        </td>
                    </tr>
...
/>`}</pre>
                        ...
                        <td width="65%">
                            <Button bsStyle="link" bsSize="xsmall"
                                    onClick={() => this.setState({ simpleTextWithDisabled: !this.state.simpleTextWithDisabled })}>
                                <i className="fa fa-code" title="show/hide code"></i>
                            </Button>
...
/>`}</pre>
                        ...
                        <td width="65%">
                            <Button bsStyle="link" bsSize="xsmall"
                                    onClick={() => this.setState({ simpleTextFieldInline: !this.state.simpleTextFieldInline })}>
                                <i className="fa fa-code" title="show/hide code"></i>
                            </Button>
                        </td>
                    </tr>
...
/>`}</pre>
                        ...
                        <td width="65%">
                            <Button bsStyle="link" bsSize="xsmall"
                                    onClick={() => this.setState({ emptyRequiredTextFieldInline: !this.state.emptyRequiredTextFieldInline })}>
                                <i className="fa fa-code" title="show/hide code"></i>
                            </Button>
                        </td>
                    </tr>
...
/>`}</pre>
                        ...
                        <td width="65%">
                            <Button bsStyle="link" bsSize="xsmall"
                                    onClick={() => this.setState({ simpleTexareatFieldInline: !this.state.simpleTexareatFieldInline })}>
                                <i className="fa fa-code" title="show/hide code"></i>
                            </Button>
                        </td>
                    </tr>
...
/>`}</pre>
                        ...
                        <td width="65%">
                            <Button bsStyle="link" bsSize="xsmall"
                                    onClick={() => this.setState({ simpleSelectCustomDispInline: !this.state.simpleSelectCustomDispInline })}>
                                <i className="fa fa-code" title="show/hide code"></i>
                            </Button>
                        </td>
                    </tr>
...
/>`}</pre>
                        ...
                        <td width="65%">
                            <Button bsStyle="link" bsSize="xsmall"
                                    onClick={() => this.setState({ customComponentInline: !this.state.customComponentInline })}>
                                <i className="fa fa-code" title="show/hide code"></i>
                            </Button>
                        </td>
                    </tr>
